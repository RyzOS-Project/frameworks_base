...
package com.android.systemui.ryz.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.ryz.header.STATUS_BAR_HEADER_UPDATE";
